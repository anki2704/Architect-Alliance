...
export const HeroSection: React.FC<HeroSectionProps> = ({ onNavigate }) => {
  ...
  */
  ...
  useEffect(() => {
    ...
    gsap.set(imageLayer, { scale: 1.04 });
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none opacity-[0.06] bg-[radial-gradient(var(--accent-amber)_0.75px,transparent_0.75px)] [background-size:26px_26px]" />
      ...
      <div ref={contentLayerRef} className="relative z-10 h-full w-full will-change-transform">
        ...
        <div className="absolute top-10 left-4 sm:top-5 sm:left-3 lg:left-6 z-20 flex items-right gap-3 sm:gap-4">
          <img
            ...
            className="h-16 sm:h-20 md:h-[5.5rem] w-auto object-contain bg-transparent"
          />
